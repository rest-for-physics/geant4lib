...
#ifndef REST_TRESTGEANT4DATAHITS_H
#define REST_TRESTGEANT4DATAHITS_H
...
class TRestGeant4DataHits {
   ...
   public:
    inline TRestGeant4DataHits() = default;
    void InsertStep(const G4Step*);

    // Casting
    operator TRestGeant4Hits() const;

    ClassDef(TRestGeant4DataHits, 1);
};

#endif  // REST_TRESTGEANT4DATAHITS_H
